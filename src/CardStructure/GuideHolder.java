//import CardStructure.CardStructure.RenderingStuff.Mesh;
//import org.joml.*;
//
//import javax.swing.text.Position;
//import java.lang.Math;
//import java.util.*;
//public class GuideHolder<E,C extends CardStructure.CardStructure.Card<E>> extends CardStructure.CardHolder{
//    CardStructure.CardHolder<E,C> playerCards;
//    Catan instance;
...
//        playerCards=new CardStructure.CardHolder<>(owner);
//        for (int i = 0; i < Player.ModelSet.values().length; i++) {
//            String file = Player.ModelSet.values()[i].ColorIndicator;
//            playerCards.add(new CardStructure.CardStructure.Card<>(null, file));
